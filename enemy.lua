...
function enemyFuncs.drawSentryBossbar()
    ...
    love.graphics.rectangle("fill", 850, 40, 220, 30)
    love.graphics.setColor(0.5, 0.1, 0, 1)
    love.graphics.rectangle("fill", 850, 40, (sentryCurrentHP/sentryMaxHP * 220), 30)
...
function enemyFuncs.drawCenturionBossbar()
    ...
    love.graphics.rectangle("fill", 850, 40, 220, 30)
    love.graphics.setColor(0.5, 0.1, 0, 1)
    love.graphics.rectangle("fill", 850, 40, (centurionCurrentHP/centurionMaxHP * 220), 30)
    love.graphics.setLineWidth(2)
    love.graphics.setLineStyle("smooth")
    love.graphics.setColor(1, 1, 1, 1)
    love.graphics.rectangle("line", 850, 40, 220, 30, 2, 2)

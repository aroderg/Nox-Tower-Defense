...
function love.draw()
    ...
    if player.location == "round" then
        ...
        love.graphics.printf(string.format("%s", notations.convertToLetterNotation(player.currencies.currentSilver, "brief")), 52, 60, 100, "left")
        love.graphics.draw(img_currency_gold, 18, 85)
        love.graphics.printf(string.format("%s", notations.convertToLetterNotation(player.currencies.currentGold, "brief")), 52, 92, 100, "left")
        love.graphics.draw(img_currency_electrum, 18, 117)
        love.graphics.printf(string.format("%s", notations.convertToLetterNotation(player.currencies.currentElectrum, "brief")), 52, 124, 100, "left")
        love.graphics.draw(img_currency_token, 18, 149)
        love.graphics.printf(string.format("%s", notations.convertToLetterNotation(player.currencies.currentTokens, "brief")), 52, 156, 100, "left")
        love.graphics.draw(img_currency_jade, 18, 181)
        love.graphics.printf(string.format("%s", notations.convertToLetterNotation(player.currencies.currentJade, "brief")), 52, 188, 100, "left")

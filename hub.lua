...
function orbital.update(reroll)
    player.misc.currentOrbital = reroll and love.math.random(1, #allOrbitals) or player.misc.currentOrbital
    return allOrbitals[player.misc.currentOrbital]
end
...
function inHub_visual()
    ...
    for i=1,#hubSections do
        if hubSection == hubSections[i] then
            love.graphics.setFont(fonts.Afacad.bold._48)
    ...
    if hubSection == "Main" then
        ...
        love.graphics.printf({{0, 1, 1, 0.6}, "(" .. allOrbitals[player.misc.currentOrbital] .. ")"}, 1024, 47, 700, "left")
        love.graphics.setFont(fonts.Afacad.semibold._28)
        ...
        love.graphics.setLineWidth(1)
        love.graphics.setFont(fonts.Afacad.regular._28)
        love.graphics.setColor(1, 1, 1, 1)
    ...
    elseif hubSection == "Abilities" then
        ...
        if player.menu.rolledAbilityDisplay then
            ...
            love.graphics.setFont(fonts.Afacad.semibold._24)
    ...
    elseif hubSection == "Shops" then
        ...
        if player.menu.shopSection == "Trading" then
            ...
            for i=1,3 do
                ...
                love.graphics.setFont(fonts.Afacad.regular._18)
                love.graphics.printf(player.activeDailyTrades[i].sellAmount, panelX, 387, 150, "center")
                ...
                love.graphics.printf(notations.convertToLetterNotation(player.activeDailyTrades[i].buyAmount), panelX, 482, 150, "center")
            ...
            for i=1,4 do
                ...
                love.graphics.setFont(fonts.Afacad.regular._18)
                love.graphics.printf(player.activeWeeklyTrades[i].sellAmount, panelX, 677, 150, "center")
                ...
                love.graphics.printf(notations.convertToLetterNotation(player.activeWeeklyTrades[i].buyAmount), panelX, 772, 150, "center")
        ...
        elseif hubSection == "Nexus" and not player.menu.settings then
            ...
            elseif x >= 1655 and x <= 1915 and y >= 465 and y <= 495 then
                if player.idleTime >= 60 then
                    ...
                    player.stats.save.goldEarned = player.stats.save.goldEarned + math.floor(player.storedGains.gold)

function towerInfo_visual()
    if not upgradeMenu then
        ...
        love.graphics.printf(string.format("%s/%s", notations.convertToLetterNotation(tower_value_currentHealth, "precise"), notations.convertToLetterNotation(tower_value_maxHealth, "precise")), 10, 993, 200, "center")
        love.graphics.draw(img_icon_player_attack, 15, 955)
        love.graphics.setFont(font_Afacad20)
        love.graphics.printf(string.format("%s", notations.convertToLetterNotation(tower_value_attack_damage, "precise")), 42, 952, 200, "left")
        ...
        love.graphics.printf(string.format("%s", notations.convertToLetterNotation(enemy_value_health, "precise")), 1722, 952, 200, "left")
        love.graphics.draw(img_icon_enemy_attack, 1695, 991)
        love.graphics.printf(string.format("%s", notations.convertToLetterNotation(enemy_value_attack_damage, "precise")), 1722, 988, 200, "left")
    ...
    elseif upgradeMenu then
        ...
        love.graphics.setFont(font_VeraBold16)
        love.graphics.printf(string.format("%s/%s", notations.convertToLetterNotation(tower_value_currentHealth, "precise"), notations.convertToLetterNotation(tower_value_maxHealth, "precise")), 10, 763, 200, "center")
        love.graphics.draw(img_icon_player_attack, 15, 725)
        love.graphics.setFont(font_Afacad20)
        love.graphics.printf(string.format("%s", notations.convertToLetterNotation(tower_value_attack_damage, "precise")), 42, 722, 200, "left")
        love.graphics.setLineWidth(1)
        love.graphics.setLineStyle("rough")
        ...
        love.graphics.printf(string.format("%s", notations.convertToLetterNotation(enemy_value_health, "precise")), 1722, 722, 200, "left")
        love.graphics.draw(img_icon_enemy_attack, 1695, 761)
        love.graphics.printf(string.format("%s", notations.convertToLetterNotation(enemy_value_attack_damage, "precise")), 1722, 758, 200, "left")

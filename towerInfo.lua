function towerInfo_visual()
    if not upgradeMenu then
        ...
        love.graphics.setColor(0.106, 0.11, 0.22, 1)
        love.graphics.rectangle("fill", 1710, 950, 200, 70)
        love.graphics.setColor(1, 1, 1, 1)
        love.graphics.rectangle("line", 1710, 950, 200, 70)
        love.graphics.draw(img_icon_enemy_health, 1715, 955)
        love.graphics.printf(string.format("%s", convertToLetterNotation(enemy_value_health, "precise")), 1742, 952, 200, "left")
        love.graphics.draw(img_icon_enemy_attack, 1715, 991)
        love.graphics.printf(string.format("%s", convertToLetterNotation(enemy_value_attack_damage, "precise")), 1742, 988, 200, "left")

        --[[ Print out gameplay info ]]--
        love.graphics.printf(string.format("Wave %d", gameplay_wave), 1805, 952, 100, "right")
        love.graphics.setLineStyle("smooth")
        ...
        if timer_untilNextWave == 0 then
            love.graphics.arc("line", 1875, 996, 20, 1.5*math.pi, 3.5*math.pi - (enemiesKilledThisWave / (6 + math.floor(gameplay_wave / 15) * 3) * 2 * math.pi))
            love.graphics.arc("fill", 1875, 996, 20, 1.5*math.pi, 3.5*math.pi - (enemiesKilledThisWave / (6 + math.floor(gameplay_wave / 15) * 3) * 2 * math.pi))
        else
            love.graphics.setColor(1, 1, 1, 1)
    ...
    elseif upgradeMenu then
        ...
        --[[ Print out enemy info ]]--
        love.graphics.setColor(0.106, 0.11, 0.22, 1)
        love.graphics.rectangle("fill", 1710, 720, 200, 70)
        love.graphics.setColor(1, 1, 1, 1)
        love.graphics.rectangle("line", 1710, 720, 200, 70)
        love.graphics.draw(img_icon_enemy_health, 1715, 725)
        love.graphics.printf(string.format("%s", convertToLetterNotation(enemy_value_health, "precise")), 1742, 722, 200, "left")
        love.graphics.draw(img_icon_enemy_attack, 1715, 761)
        love.graphics.printf(string.format("%s", convertToLetterNotation(enemy_value_attack_damage, "precise")), 1742, 758, 200, "left")

        --[[ Print out gameplay info ]]--
        love.graphics.printf(string.format("Wave %d", gameplay_wave), 1805, 722, 100, "right")
        love.graphics.setLineStyle("smooth")
        love.graphics.setColor(0.2, 0.2, 0.2, 1)

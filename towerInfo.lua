...
function towerInfo_visual()
    if not player.menu.upgrades then
        ...
        if player.tower.currentHealth > 0 then
            ...
            love.graphics.rectangle("fill", 15, 990, (player.tower.currentHealth/player.tower.health) * 190, 25, 2, 2)
        end
        love.graphics.setColor(1, 1, 1, 1)
        love.graphics.rectangle("line", 15, 990, 190, 25, 2, 2)
        love.graphics.setFont(font_VeraBold16)
        love.graphics.printf(string.format("%s/%s", notations.convertToLetterNotation(player.tower.currentHealth, "precise"), notations.convertToLetterNotation(player.tower.health, "precise")), 10, 993, 200, "center")
        ...
        if player.tower.currentHealth > 0 then
            love.graphics.setColor(0, 0.5, 0.2, 1)
            love.graphics.rectangle("fill", 15, 760, (player.tower.currentHealth/player.tower.health) * 190, 25, 2, 2)
        end
        love.graphics.setColor(1, 1, 1, 1)
        love.graphics.rectangle("line", 15, 760, 190, 25, 2, 2)
        love.graphics.setFont(font_VeraBold16)
        love.graphics.printf(string.format("%s/%s", notations.convertToLetterNotation(player.tower.currentHealth, "precise"), notations.convertToLetterNotation(player.tower.health, "precise")), 10, 763, 200, "center")

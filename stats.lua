...
function statsMenus.battle.draw()
    ...
    if player.tower.currentHealth > 0 then
        love.graphics.draw(imgs.buttons.arrowLeft_big, 674, 522)
    end
    local statNames = {
        "Battle Time (in-game)",
        "Battle Time (real)",
    ...
    love.graphics.setColor(accentColors[player.misc.theme].buttons)
        love.graphics.rectangle("fill", 890, 785, 140, 40)
        love.graphics.setColor(accentColors[player.misc.theme].buttonOutlines)
        love.graphics.setLineWidth(2)
        love.graphics.rectangle("line", 890, 785, 140, 40, 2, 2)
        love.graphics.setFont(fonts.Afacad.regular._24)
        love.graphics.setColor(1, 1, 1, 1)
        love.graphics.printf("Back", 890, 787, 140, "center")
end
...
function statsMenus.enemyInfo.draw()
    ...
    love.graphics.draw(imgs.enemies.basic, 770, 270 + math.floor(statTextScrollState), 0, 40/20, 40/20)
    ...
    love.graphics.draw(imgs.enemies.tank, 770, 390 + math.floor(statTextScrollState), 0, 40/32, 40/32)
    ...
    love.graphics.draw(imgs.enemies.swift, 770, 510 + math.floor(statTextScrollState), 0, 40/16, 40/16)
    ...
    love.graphics.draw(imgs.enemies.sentry, 770, 680 + math.floor(statTextScrollState), 0, 40/44, 40/44)
    ...
    love.graphics.draw(imgs.enemies.centurion, 770, 850 + math.floor(statTextScrollState), 0, 40/60, 40/60)
    ...
    love.graphics.draw(imgs.enemies.exploder_static, 770, 1020 + math.floor(statTextScrollState), 0, 40/24, 40/24)

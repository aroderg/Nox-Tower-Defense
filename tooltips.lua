    ...
    if player.settings.tooltips then
        ...
        local roundTooltips = {
            ["ATK"] = {
                ...
                {10, 990, 254, 60, 280, 40, "Chance to deal increased projectile damage.", string.format("Level: %d (%d+%d)/%d", player.upgrades.round.critChance.level, player.upgrades.science.critChance.level, player.upgrades.round.critChance.level - player.upgrades.science.critChance.level, 51), ["precedingUpgrade"] = player.upgrades.unlocks.crit}, --Critical Chance Round upgrade tooltip
                ...
                {370, 990, 254, 60, 310, 40, "Chance to shoot several enemies simultaneously.", string.format("Level: %d (%d+%d)/%d", player.upgrades.round.clusterFireChance.level, player.upgrades.science.clusterFireChance.level, player.upgrades.round.clusterFireChance.level - player.upgrades.science.clusterFireChance.level, 76), ["precedingUpgrade"] = player.upgrades.unlocks.clusterFire}, --Cluster Fire Chance Round upgrade tooltip
        ...
        local scienceTooltips = {
            ...
            {605, 310, 254, 60, 310, 40, "Chance to shoot several enemies simultaneously.", string.format("Level: %d/%d", math.min(player.upgrades.science.clusterFireChance.level, 76), 76), 76, ["precedingUpgrade"] = player.upgrades.unlocks.clusterFire}, --Cluster Fire Chance Science upgrade tooltip

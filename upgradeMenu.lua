...
function drawUpgradeMenu()
    if player.menu.upgrades then
        ...
        love.graphics.rectangle("fill", 860, 720, 200, 70)
        love.graphics.setColor(accentColors[player.misc.theme].buttonOutlines)
        love.graphics.rectangle("line", 860, 720, 200, 70, 2, 2)
        love.graphics.setColor(1, 1, 1, 1)
        love.graphics.setFont(font_AfacadBold24)
        love.graphics.printf("Upgrades", 860, 737, 200, "center")
        ...
        love.graphics.setLineWidth(2)
        love.graphics.setColor(accentColors[player.misc.theme].towerInfo)
        love.graphics.rectangle("fill", 860, 1000, 200, 70)
        love.graphics.setColor(accentColors[player.misc.theme].buttonOutlines)
        love.graphics.rectangle("line", 860, 1000, 200, 70, 2, 2)
        love.graphics.setColor(1, 1, 1, 1)
        love.graphics.setFont(font_AfacadBold24)
        love.graphics.printf("Upgrades", 860, 1017, 200, "center")
        love.graphics.setLineStyle("rough")
        love.graphics.setLineWidth(1)
    end
end
